...
internal static class Constants
{
    ...
    public const byte SubdivisionBracketOpenChar  = (byte)'{';
    public const byte SubdivisionBracketCloseChar = (byte)'}';
    public const byte DurationBracketOpenChar     = (byte)'[';
    public const byte DurationBracketCloseChar    = (byte)']';
    ...
    public const byte NewSlideChar                = (byte)'*';
    public const byte StraightLineChar            = (byte)'-';
    public const byte RingRightChar               = (byte)'>';
    public const byte RingLeftChar                = (byte)'<';
